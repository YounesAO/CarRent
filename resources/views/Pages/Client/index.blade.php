...
<form action="{{ url('/profile/client', []) }}" method="POST" class="d-flex  justify-content-center align-items-center flex-wrap">
    ...
    <input class="form-control col-lg-4 m-1" type="text" name="CIN" placeholder="Numéro de la catre nationale">
    <input class="btn btn-success col-lg-2 col-sm-3 col-11 m-1" type="submit" value="Chercher">
    <a class="btn btn-warning shadow-none col-lg-2 col-sm-3 col-11 m-1" href="Clients" >tous les clients</a>
